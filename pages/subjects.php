<?php $core->pageTitle("Fagoversikt"); ?>

<body class="d-flex flex-column h-100">
    <?php $core->getNavbar(); ?>
    <main role="main" class="flex-shrink-0">
        <div class="container">
            <h1 class="mt-5">Fagoversikt</h1>
            <p class="lead">På denne siden kan du se alle dine fag. Trykk på fagemnet for å behandle et fag.</p>

            <div class="mt-3 mb-4">
                <button type="button" class="btn btn-outline-primary btn-lg" data-toggle="modal" data-target="#exampleModalCenter">Legg til fag</button>
                <button type="button" class="btn btn-outline-primary btn-lg ml-2" data-toggle="modal" data-target="#exampleModalCenter">Endre fag</button>
                <!-- vurder center her? -->
            </div>
